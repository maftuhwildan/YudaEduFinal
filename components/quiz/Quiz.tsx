...
export const Quiz: React.FC<QuizProps> = ({ user, onFinish, onLogout }) => {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col h-screen overflow-hidden select-none">
            ...
            <div className="bg-card border-b px-2 sm:px-4 py-2 shrink-0 overflow-x-auto">
                    ...
                    {questions.map((q, i) => {
                        ...
                        return (
                            <Button
                                ...
                                className={`shrink-0 w-9 h-9 sm:w-10 sm:h-10 rounded-lg text-xs sm:text-sm font-semibold transition-all duration-150 border-2 ${isCurrent
